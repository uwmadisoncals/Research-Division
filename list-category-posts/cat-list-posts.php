...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= $this->get_post_title($single, 'h2', 'entry-title');

    //Show comments:
    $lcp_display_output .= $this->get_comments($single);
	
	
	//Place meta info inside div:
	$lcp_display_output .= '<div class="entry-meta">';
	
	//Display Posted on before post date:
	$lcp_display_output .= '<span class="meta-prep meta-prep-author">Posted on</span>';
