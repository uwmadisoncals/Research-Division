...
<!--Post navigation restricted to posts in same category using previous_post_link(x, x, TRUE). See http://codex.wordpress.org/Template_Tags/previous_post_link for more information.-->
